...
export const Personalisation = styled.span`
  position: fixed;
  font-weight: bold;
  color: #003b45;
...
export function NavigationHeader() {
  ...
  const headerText = version === "classic-only"
    ? "work with Classic programs"
    : version === "ga-only"
      ? "work with non-Classic programs"
      : "work with all programs";
  return (<header id="my-header" style={{ marginTop: "60px" }}>
    <div className="navbar navbar-top">
      <div className="navbar-inner">
        <div className="container-fluid">
          <button className="hamburger hamburger--collapse pull-right hidden-desktop" type="button" data-toggle="collapse" data-target="#navigation">
    ...
    <div className="container-fluid hidden-desktop">
      <button className="hamburger hamburger--arrow" type="button" id="open-sidenav">
        <span className="hamburger-box">
          <span className="hamburger-inner"></span>
        </span>
      </button>
