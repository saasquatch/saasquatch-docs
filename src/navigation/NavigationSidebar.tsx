...
// @ts-ignore
const DropDownChild = styled(DropDownParent)`
  font-size: 14px;
  line-height: 21px;
  font-weight: 400;
        ...
        <ul className="baseMenu">
          ...
          <MainMenuLi>
            ...
            <ul>
              ...
              <DropdownMenuList>
                <DropDownChild>Salesforce section 1</DropDownChild>
                <DropDownChild>Salesforce section 2</DropDownChild>
                <DropDownChild>Salesforce section 3</DropDownChild>
              </DropdownMenuList>
            </ul>
          </MainMenuLi>
        </ul>
