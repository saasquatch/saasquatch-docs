              ...
              <DropdownParentLi>
                ...
                {isActive("restAPI") && (
                  <DropdownMenuList>
                    ...
                    {/* Nested API menu starts here */}
                    <APIDropdownParentLi>
                      <StyledLink
                        onClick={() => toggleActivePage("testingAPI")}
                        dropdownSelected={isActive("testingAPI")}
                      >
                        <DropdownParentContainer>
                          Testing API
                          <SVGIcon
                      ...
                      {/* Menu items inside Testing API start here */}
                      {isActive("testingAPI") && (
                        <DropdownMenuList>
                          {/* Menu item with title and 1 button starts here */}
                          <DropdownChildLi
                          ...
                          {/* Another menu item with title and 2 buttons starts here */}
                          <DropdownChildLi clicked={currentPage === "#"}>
