...
- [CSV](/assets/samples/sample-user-upload.csv)
- [JSONL](/assets/samples/userImportSample.jsonl)

Event data imports:

- [CSV](/assets/samples/userEventSample.csv)
- [JSONL](/assets/samples/userEventSample.jsonl)
