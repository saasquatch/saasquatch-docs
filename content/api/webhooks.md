...
#### <span class="label">Classic only</span> Classic user.created
...
#### GA (non-classic) referral.started
...
#### <span class="label">Classic only</span> Classic referral.started
...
#### GA (non-classic) referral.converted
...
#### <span class="label">Classic only</span> Classic referral.converted
