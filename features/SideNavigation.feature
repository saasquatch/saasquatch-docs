...
@ui
   ...
   Scenario Outline: Selected menu item state in the side navigation bar
       ...
       Examples:
           ...
           | Core Category Section with navigation arrow | N/A                 | N/A                 | N/A        | N/A         | navigate to a corresponding side bar                  | corresponding content page opening up |
           | Parent                                      | 003B45 (dark green) | FFFFFF              | N/A        | N/A         | corresponding content page opening up                 | N/A                                   |
           | Parent with dropdown arrow                  | FFFFFF              | 003B45 (dark green) | bold       | N/A         | arrow point up                                        | N/A                                   |
           | Child                                       | 003B45 (dark green) | FFFFFF              | bold       | N/A         | dropdown line changes to 2px width and green (06966F) | corresponding content page opening up |
           | Child with dropdown arrow                   | FFFFFF              | 003B45 (dark green) | bold       | N/A         | arrow point up                                        | N/A                                   |
